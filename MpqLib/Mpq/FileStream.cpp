...
System::Int64 MpqLib::Mpq::CFileStream::CompressedLength::get()
{
	...
	if (SFileGetFileInfo(_Handle, SFILE_INFO_COMPRESSED_SIZE, &ret, 8))
		return ret;
	throw gcnew System::Exception("SFileGetFileInfo failed in CompressedLength::get()");
}
...
LCID MpqLib::Mpq::CFileStream::Locale::get()
{
	...
	DWORD ret;
	if (SFileGetFileInfo(_Handle, SFILE_INFO_LOCALEID, &ret, 4))
		return ret;
	throw gcnew System::Exception("SFileGetFileInfo failed in Locale::get()");
}
...
System::Void MpqLib::Mpq::CFileStream::Open()
{
	...
	DWORD length;
	SFileGetFileInfo(_Handle, SFILE_INFO_FILE_SIZE, &length, 4);
	_Length = length;

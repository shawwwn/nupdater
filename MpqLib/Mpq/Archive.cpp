...
MpqLib::Mpq::CArchive::CArchive(System::String^ FileName)
{
	...
	Open(false, EArchiveFormat::Version4, CConstants::DefaultHashTableSize);
}
...
MpqLib::Mpq::CArchive::CArchive(System::String^ FileName, System::Boolean CreateIfNotExists)
{
	...
	Open(CreateIfNotExists, EArchiveFormat::Version4, CConstants::DefaultHashTableSize);
}
...
System::Void MpqLib::Mpq::CArchive::ExportFile(System::String^ FileName, System::String^ RealFileName)
{
	...
	if(!SFileExtractFile(_Handle, FileNameHandle.Value, RealFileNameHandle.Value)) throw gcnew System::IO::IOException("Unable to export \"" + FileName + "\" as \"" + RealFileName + "\"!");
}
...
System::Int32 MpqLib::Mpq::CArchive::FileCount::get()
{
	...
	DWORD ret;
	if (SFileGetFileInfo(_Handle, SFILE_INFO_NUM_FILES, &ret, 4))
		return ret;
	throw gcnew System::Exception("SFileGetFileInfo failed in FileCount::get()");
}
...
System::Void MpqLib::Mpq::CArchive::Open(System::Boolean CreateIfNotExists, EArchiveFormat ArchiveFormat, System::UInt32 HashTableSize)
{
	...
	{
		if (!SFileOpenArchive(FileNameHandle.Value, 1, 0,  HandlePointer)) throw gcnew System::IO::IOException("Unable to open \"" + _FileName + "\"!");
	}
	else
	{
		...
		if(!SFileCreateArchive(FileNameHandle.Value, BuildArchiveFlags(ArchiveFormat), HashTableSize, HandlePointer)) throw gcnew System::IO::IOException("Unable to open or create \"" + _FileName + "\"!");
	}
}
...
System::UInt32 MpqLib::Mpq::CArchive::BuildArchiveFlags(EArchiveFormat ArchiveFormat)
{
	...
	switch(ArchiveFormat)
	{
		...
		case EArchiveFormat::Version3:
			{
				Flags |= MPQ_CREATE_ARCHIVE_V3;
				break;
			}

		case EArchiveFormat::Version4:
			{
				Flags |= MPQ_CREATE_ARCHIVE_V4;
				break;
			}
	}
